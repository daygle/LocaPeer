...
- **Privacy & Live-Mode Settings** - Opt-in/out of "Allow Live Boost" (speed up updates when watched) and "Request Live Updates" (ask others for faster updates when the map is open) in Settings.
