...
- **Real-time Location Sharing** - Broadcast your location on a configurable schedule or continuously; contacts see your live position on an interactive map. "Live View" (kind 1060) automatically boosts your update cadence when a contact is actively viewing the map.
...
| 1059 | `CIRCLE_LEAVE` | Notify circle owner of member departure |
| 1060 | `LIVE_VIEW_REQUEST` | Request a short-term location update boost |
